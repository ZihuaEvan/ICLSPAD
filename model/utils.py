...
def initialize_tree(input_ids,model, tree_attn_mask, logits_processor, past_key_values=None, pixel_values=None, image_grid_thw=None,pixel_values_videos=None,video_grid_thw=None):
